...
WEB_DIR = Path(**file**).resolve().parent.parent / "web"
...
Previously, the application processed the entire inbox here, which could
cause the Render Free instance to exceed its 512 MB memory limit before
the API finished starting.
